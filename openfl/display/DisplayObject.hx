...
class DisplayObject extends EventDispatcher implements IBitmapDrawable #if !disable_dynamic_child_access implements #if (flash && !flash_strict) Dynamic #else Dynamic<DisplayObject> #end #end {
